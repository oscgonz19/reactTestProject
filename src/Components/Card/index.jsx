...
const Card = (data) => {
    ...
    return(
        <div className='bg-white/50 cursor-pointer w-56 h-60 rounded-lg p-3 shadow-lg z-10'
            ...
            <figure className='relative mb-2 w-full h-4/5'>
                <span className='absolute bottom-0 left-0 bg-white/60 rounded-lg text-black text-sm m-2 px-3 py-0.5'>{data.data.category}</span>
                    <img className='w-full h-full rounded-lg' src={data.data.image} alt={data.data.title} />
